...
/**
 * An edit screen with a Tabs + ResourceTable layout (generated by a host
 * resource through `formLayout('update')`).
 */
...
it('editScreen returns Tabs layout with embedded admin.resource-table tab', function (): void {
    ...
    // Inside the second tab sits our ResourceTable layout node.
